CONFIG_PATHS = {'bg_5_label': '/home/slenzi/winstor/margrie/slenzi/dlc/config_.yaml',
...
BODYPART_LABELS = {
                    ...
                    'bg_5_label': ['nose', 'L_ear','R_ear', 'shoulder_blades', 'tail_base', 'tail_tip'],
                    'bg_5_label_SL_new': ['nose', 'L_ear','R_ear', 'body', 'tail_base', 'tail_tip'],
