...
from looming_spots.analysis.event_detection.gui.image_providers import (
    PyplotImageProvider,
)
from looming_spots.analysis.event_detection.gui.detection_interface import (
    DetectionInterface,
)
...
def get_main_window(app_engine):
    if sys.platform == "win32":
        base_dir = os.path.abspath(
            os.path.normpath("./analysis/event_detection/gui/")
